...
const QUERY_DELETE_FROM_PRODUCTS_TABLE =
  "DELETE FROM products WHERE productId =";
const QUERY_DELETE_FROM_CATEGORIES_TABLE =
  "DELETE FROM categories WHERE categoryId =";
 const QUERY_UPDATE_PRODUCT = "UPDATE products SET productName = ?, productImage = ?,  productPrice = ?,  productStockQuantity = ?,  productCategoryName = ? WHERE productId = ?";
...
const EVENT_UPDATE_PRODUCT = "update product";
